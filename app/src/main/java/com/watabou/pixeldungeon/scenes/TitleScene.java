...
public class TitleScene extends PixelScene {
    ...
    private static final String TXT_PLAY = Game.instance.getString(R.string.Play);
    private static final String TXT_HIGHSCORES = Game.instance.getString(R.string.Rankings);
    private static final String TXT_BADGES = Game.instance.getString(R.string.Badges);
    private static final String TXT_ABOUT = Game.instance.getString(R.string.About);
