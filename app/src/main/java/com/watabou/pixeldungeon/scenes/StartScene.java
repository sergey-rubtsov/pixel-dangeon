...
public class StartScene extends PixelScene {
    ...
    private static final String TXT_LOAD = Game.instance.getString(R.string.Load_Game);
    private static final String TXT_NEW = Game.instance.getString(R.string.New_Game);

    private static final String TXT_ERASE = Game.instance.getString(R.string.Erase_current_game);
    private static final String TXT_DPTH_LVL = Game.instance.getString(R.string.Depth_level);

    private static final String TXT_REALLY = Game.instance.getString(R.string.want_start_new_game);
    private static final String TXT_WARNING = Game.instance.getString(R.string.progress_will_be_erased);
    private static final String TXT_YES = Game.instance.getString(R.string.new_game);
    private static final String TXT_NO = Game.instance.getString(R.string.to_main_menu);

    private static final String TXT_UNLOCK = Game.instance.getString(R.string.unlock_huntress);

    private static final String TXT_WIN_THE_GAME =
            Game.instance.getString(R.string.unlock_challenges);
