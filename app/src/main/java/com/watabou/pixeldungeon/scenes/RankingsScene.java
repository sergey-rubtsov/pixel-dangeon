...
public class RankingsScene extends PixelScene {
    ...
    private static final String TXT_TITLE = Game.instance.getString(R.string.Top_Rankings);
    private static final String TXT_TOTAL = Game.instance.getString(R.string.Games_played);
    private static final String TXT_NO_GAMES = Game.instance.getString(R.string.No_games_have_been_played_yet);

    private static final String TXT_NO_INFO = Game.instance.getString(R.string.No_additional_information);
