...
public class GameScene extends PixelScene {
    ...
    private static final String TXT_WELCOME = Game.instance.getString(R.string.Welcome_to_the_level);
    private static final String TXT_WELCOME_BACK = Game.instance.getString(R.string.Welcome_back_to_the_level);
    private static final String TXT_NIGHT_MODE = Game.instance.getString(R.string.dungeon_is_even_more_dangerous_at_night);

    private static final String TXT_CHASM = Game.instance.getString(R.string.echo_across);
    private static final String TXT_WATER = Game.instance.getString(R.string.hear_the_water);
    private static final String TXT_GRASS = Game.instance.getString(R.string.smell_of_vegetation);
    private static final String TXT_SECRETS = Game.instance.getString(R.string.floor_hides_many_secrets);
    ...
    @Override
    public void create() {
        if (Dungeon.depth == 0 || Dungeon.depth == 1) {
            Music.INSTANCE.play(Assets.TUNE, true);
        } else {
            Music.INSTANCE.play(Assets.MUSIC[Random.Int(Assets.MUSIC.length - 1)], true);
        }
